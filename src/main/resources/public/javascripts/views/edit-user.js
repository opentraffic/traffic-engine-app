...
(function(A, views, translator, C, dc) {
  ...
  views.EditUser = Marionette.Layout.extend({

    template: Handlebars.getTemplate('app', 'edit-user'),
    tagName:   'div',
    className: 'edit-user-area',

    ui: {
      loginForm:           '#editUserForm',
    ...
    formSubmitted: function(event) {
      ...
      A.app.instance.vent.trigger('edit-user:submit', this.model)
    },
    ...
    onRender : function () {
      ...
      switch(this.model.get('state')) {
        case this.model.pendingUpdateState:
        ...
        case this.model.updateFailState:
          this.ui.generalErrorMessage.show();
          break;

       case this.model.updateSuccessState:
          this.ui.successMessage.show();
          A.app.instance.vent.trigger('edit-user:success')
